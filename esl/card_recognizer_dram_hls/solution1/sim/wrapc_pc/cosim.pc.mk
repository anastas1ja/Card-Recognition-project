...
$(ObjDir)/card_recognizer_dram_hls.cpp_pre.cpp.tb.o : card_recognizer_dram_hls.cpp_pre.cpp.tb.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling card_recognizer_dram_hls.cpp_pre.cpp.tb.cpp" $(AVE_DIR_DLOG)
	$(Verb) $(CC) ${CCFLAG} ${TOOLCHAIN}  -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

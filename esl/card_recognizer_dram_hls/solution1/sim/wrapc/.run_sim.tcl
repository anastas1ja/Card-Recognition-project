...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "card_recognizer_hw.autotvin.dat"
	set constFileTvOut       "card_recognizer_hw.autotvout.dat"
	set constFileHdlTvIn     "card_recognizer_hw.autohdltvin.dat"
	set constFileHdlTvOut    "card_recognizer_hw.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"

...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { curr_label_V_address0 { O 7 vector } curr_label_V_ce0 { O 1 bit } curr_label_V_q0 { I 8 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { curr_label_V_1_address0 { O 7 vector } curr_label_V_1_ce0 { O 1 bit } curr_label_V_1_q0 { I 8 vector } } \
} "
} else {

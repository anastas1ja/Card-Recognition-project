...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename parent_V \
    op interface \
    ports { parent_V_address0 { O 8 vector } parent_V_ce0 { O 1 bit } parent_V_we0 { O 1 bit } parent_V_d0 { O 8 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename min_x_V \
    op interface \
    ports { min_x_V_address0 { O 8 vector } min_x_V_ce0 { O 1 bit } min_x_V_we0 { O 1 bit } min_x_V_d0 { O 8 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename min_y_V \
    op interface \
    ports { min_y_V_address0 { O 8 vector } min_y_V_ce0 { O 1 bit } min_y_V_we0 { O 1 bit } min_y_V_d0 { O 8 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename max_x_V \
    op interface \
    ports { max_x_V_address0 { O 8 vector } max_x_V_ce0 { O 1 bit } max_x_V_we0 { O 1 bit } max_x_V_d0 { O 8 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename max_y_V \
    op interface \
    ports { max_y_V_address0 { O 8 vector } max_y_V_ce0 { O 1 bit } max_y_V_we0 { O 1 bit } max_y_V_d0 { O 8 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename count \
    op interface \
    ports { count_address0 { O 8 vector } count_ce0 { O 1 bit } count_we0 { O 1 bit } count_d0 { O 32 vector } } \
} "
} else {

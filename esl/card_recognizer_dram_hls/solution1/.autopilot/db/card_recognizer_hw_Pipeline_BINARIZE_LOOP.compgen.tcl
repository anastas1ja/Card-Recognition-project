...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename gray_V \
    op interface \
    ports { gray_V_address0 { O 15 vector } gray_V_ce0 { O 1 bit } gray_V_q0 { I 8 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'gray_V'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename binary_V \
    op interface \
    ports { binary_V_address1 { O 15 vector } binary_V_ce1 { O 1 bit } binary_V_we1 { O 1 bit } binary_V_d1 { O 1 vector } } \
} "
} else {

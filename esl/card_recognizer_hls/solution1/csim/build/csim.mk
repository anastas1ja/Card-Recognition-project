...
HLS_SOURCES = ../../../../testbench.cpp ../../../../card_recognizer_hls.cpp
...
$(ObjDir)/card_recognizer_hls.o: ../../../../card_recognizer_hls.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../card_recognizer_hls.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CC) ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/card_recognizer_hls.d

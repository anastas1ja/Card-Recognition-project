...
set name card_recognizer_hw_fadd_32ns_32ns_32_5_full_dsp_1
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {fadd} IMPL {fulldsp} LATENCY 4 ALLOW_PRAGMA 1
}


set name card_recognizer_hw_fmul_32ns_32ns_32_4_max_dsp_1
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {fmul} IMPL {maxdsp} LATENCY 3 ALLOW_PRAGMA 1
}


set name card_recognizer_hw_sitofp_32ns_32_6_no_dsp_1
if {${::AESL::PGuard_rtl_comp_handler}} {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename gray \
    op interface \
    ports { gray_address0 { O 19 vector } gray_ce0 { O 1 bit } gray_we0 { O 1 bit } gray_d0 { O 8 vector } } \
} "
} else {

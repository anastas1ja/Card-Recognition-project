set moduleName find_largest_component_hw_Pipeline_VITIS_LOOP_31_1
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {find_largest_component_hw_Pipeline_VITIS_LOOP_31_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ n int 32 regular  }
	{ visited int 1 regular {array 307200 { 0 3 } 0 1 } {global 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "n", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "visited", "interface" : "memory", "bitwidth" : 1, "direction" : "WRITEONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ visited_address0 sc_out sc_lv 19 signal 1 } 
...
set Spec2ImplPortList { 
	...
	visited { ap_memory {  { visited_address0 mem_address 1 19 }  { visited_ce0 mem_ce 1 1 }  { visited_we0 mem_we 1 1 }  { visited_d0 mem_din 1 1 } } }
}

...
void XCard_recognizer_hw_Set_input_rgb(XCard_recognizer_hw *InstancePtr, u64 Data) {
    ...
    XCard_recognizer_hw_WriteReg(InstancePtr->Control_BaseAddress, XCARD_RECOGNIZER_HW_CONTROL_ADDR_INPUT_RGB_DATA, (u32)(Data));
    XCard_recognizer_hw_WriteReg(InstancePtr->Control_BaseAddress, XCARD_RECOGNIZER_HW_CONTROL_ADDR_INPUT_RGB_DATA + 4, (u32)(Data >> 32));
}
...
u64 XCard_recognizer_hw_Get_input_rgb(XCard_recognizer_hw *InstancePtr) {
    ...
    Data = XCard_recognizer_hw_ReadReg(InstancePtr->Control_BaseAddress, XCARD_RECOGNIZER_HW_CONTROL_ADDR_INPUT_RGB_DATA);
    Data += (u64)XCard_recognizer_hw_ReadReg(InstancePtr->Control_BaseAddress, XCARD_RECOGNIZER_HW_CONTROL_ADDR_INPUT_RGB_DATA + 4) << 32;
    return Data;
}

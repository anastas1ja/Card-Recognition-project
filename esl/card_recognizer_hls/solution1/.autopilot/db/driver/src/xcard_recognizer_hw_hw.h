...
#define XCARD_RECOGNIZER_HW_CONTROL_ADDR_INPUT_RGB_DATA   0x10
#define XCARD_RECOGNIZER_HW_CONTROL_BITS_INPUT_RGB_DATA   64
#define XCARD_RECOGNIZER_HW_CONTROL_ADDR_RESULT_RANK_DATA 0x1c
#define XCARD_RECOGNIZER_HW_CONTROL_BITS_RESULT_RANK_DATA 32
#define XCARD_RECOGNIZER_HW_CONTROL_ADDR_RESULT_RANK_CTRL 0x20
#define XCARD_RECOGNIZER_HW_CONTROL_ADDR_RESULT_SUIT_DATA 0x2c
#define XCARD_RECOGNIZER_HW_CONTROL_BITS_RESULT_SUIT_DATA 32
#define XCARD_RECOGNIZER_HW_CONTROL_ADDR_RESULT_SUIT_CTRL 0x30
#define XCARD_RECOGNIZER_HW_CONTROL_ADDR_WIDTH_DATA       0x3c
#define XCARD_RECOGNIZER_HW_CONTROL_BITS_WIDTH_DATA       32
#define XCARD_RECOGNIZER_HW_CONTROL_ADDR_HEIGHT_DATA      0x44

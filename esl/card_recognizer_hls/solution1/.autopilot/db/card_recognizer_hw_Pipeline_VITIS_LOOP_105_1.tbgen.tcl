set moduleName card_recognizer_hw_Pipeline_VITIS_LOOP_105_1
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {card_recognizer_hw_Pipeline_VITIS_LOOP_105_1}
set C_modelType { void 0 }
set C_modelArgList {
	{ gmem int 8 regular {axi_master 0}  }
	{ input_rgb int 64 regular  }
	{ trunc_ln int 31 regular  }
	{ gray int 8 regular {array 307200 { 0 3 } 0 1 } {global 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 8, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "input_rgb","offset": { "type": "dynamic","port_name": "input_rgb","bundle": "control"},"direction": "READONLY"}]}]} , 
 	...
 	{ "Name" : "gray", "interface" : "memory", "bitwidth" : 8, "direction" : "WRITEONLY", "extern" : 0} ]}
...
set portList { 
	...
	{ gray_address0 sc_out sc_lv 19 signal 3 } 
	{ gray_ce0 sc_out sc_logic 1 signal 3 } 
	{ gray_we0 sc_out sc_logic 1 signal 3 } 
	{ gray_d0 sc_out sc_lv 8 signal 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "gray_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "gray", "role": "we0" }} , 
 	{ "name": "gray_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "gray", "role": "d0" }}  ]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "27", "Max" : "-1"}
	, {"Name" : "Interval", "Min" : "27", "Max" : "-1"}
]}
...
set Spec2ImplPortList { 
	...
	gray { ap_memory {  { gray_address0 mem_address 1 19 }  { gray_ce0 mem_ce 1 1 }  { gray_we0 mem_we 1 1 }  { gray_d0 mem_din 1 8 } } }
}

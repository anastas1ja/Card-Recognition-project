...
typedef struct {
    ...
    XCard_recognizer_hw_uio_map maps[ MAX_UIO_MAPS ];
} XCard_recognizer_hw_uio_info;

/***************** Variable Definitions **************************************/
static XCard_recognizer_hw_uio_info uio_info;
...
static int uio_info_read_name(XCard_recognizer_hw_uio_info* info) {
    char file[ MAX_UIO_PATH_SIZE ];
    sprintf(file, "/sys/class/uio/uio%d/name", info->uio_num);
    return line_from_file(file, info->name);
}

static int uio_info_read_version(XCard_recognizer_hw_uio_info* info) {
    char file[ MAX_UIO_PATH_SIZE ];
    sprintf(file, "/sys/class/uio/uio%d/version", info->uio_num);
    return line_from_file(file, info->version);
}

static int uio_info_read_map_addr(XCard_recognizer_hw_uio_info* info, int n) {
    int ret;
    char file[ MAX_UIO_PATH_SIZE ];
...
static int uio_info_read_map_size(XCard_recognizer_hw_uio_info* info, int n) {
    int ret;
    char file[ MAX_UIO_PATH_SIZE ];
...
int XCard_recognizer_hw_Initialize(XCard_recognizer_hw *InstancePtr, const char* InstanceName) {
	XCard_recognizer_hw_uio_info *InfoPtr = &uio_info;
